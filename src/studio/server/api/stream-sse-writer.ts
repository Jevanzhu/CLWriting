 ...
 *
 * R0916-5h（2026-09-16，⑤④产品巨件拆分波4）：stream.ts（879 行）缝 A+B 纯移动拆分。
 * 本文件承载缝 A：P2-2/S2 per-book SSE 连接记账族（SseConnHandle 句柄化 Set 账目、
 * MAX_SSE_PER_BOOK 上限、forgetSseCount / closeAllSseConnections 终态清账、
 * __getSseConnections 测试观测钩子）+ P-8/R64-26/R65-42 SSE 写出器族（createSseWriter
