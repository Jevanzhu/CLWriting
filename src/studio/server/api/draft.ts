 ...
 *
 * 草稿落盘 + prompt 组装逻辑已下沉 src/process/draft-pipeline.ts（架构治理），
...
/** 等待某书在途 draft-save 串行链排空——books.ts 删书/改名排水段
...
/** 测试观测钩子（files.ts __filePutChainKeysForTest 同款）——当前
