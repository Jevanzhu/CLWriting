...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/books/:name/o2', component: () => import('./pages/OverviewO2.vue') },
    { path: '/books/:name/o3', component: () => import('./pages/OverviewO3.vue') },
    { path: '/books/:name/o4', component: () => import('./pages/OverviewO4.vue') },
    { path: '/books/:name/o5', component: () => import('./pages/OverviewO5.vue') },
