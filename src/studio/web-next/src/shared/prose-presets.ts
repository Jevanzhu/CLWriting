 ...
 * ④：字体身份匹配改为族键比对（zh/en 异名、思源/Noto 双产品同族，见
...
/** 预设工厂：desc 的「（Npx · M）」尾缀由 values 派生（⑥）——改档只改
...
/** 预设组·mac：三套均 mac 恒装族（苹方/冬青黑体/宋体-简），无「未装」
 ...
 *  平台分流：只对当前平台组匹配——他平台预设值（如 mac 上存过
