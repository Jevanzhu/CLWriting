/**
 * 文档 revision —— 文件原始字节 SHA-256（§5）。
 *
 * revision 是保存协议的并发控制依据（不以 mtime 为唯一判据）。
 * 字节指纹单源于 fs/hash.ts（M10 下沉），与 gate/confirm 的确认哈希同源——
