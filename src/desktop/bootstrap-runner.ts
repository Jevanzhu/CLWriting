    ...
    runBootstrap(onError?: (e: unknown) => void): void {
      ...
      void (async () => {
        try {
          ...
          // （打包修复批）：close 同步先调（兼容旧口径），若返回 Promise 则等其
