 ...
 * 两个方向都可失真：紧排 `##标题`（认可的合法形态）在 metrics 侧全部漏识
 ...
 * （collectBodyAnchors 锚点集）——两处同源，消口径分裂面。 */
