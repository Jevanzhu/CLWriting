...
[![Test](https://img.shields.io/badge/tests-1347%20all%20green-4FC08D?logo=vitest&logoColor=white)](#-项目状态)
...
| 测试 | vitest（1347 单测）+ Playwright（24 e2e） |
...
- **159 个测试文件 / 1347 单测全绿 + 24 个 e2e 全绿**，`tsc --noEmit` 通过，`build:all` 构建通过。
