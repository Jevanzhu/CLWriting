...
[![Test](https://img.shields.io/badge/tests-1151%20all%20green-4FC08D?logo=vitest&logoColor=white)](#-项目状态)
...
| 测试 | vitest（1151 单测）+ Playwright（15 e2e） |
...
- **138 个测试文件 / 1151 单测全绿 + 15 个 e2e 全绿**，`tsc --noEmit` 通过，`build:all` 构建通过。
