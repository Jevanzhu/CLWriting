...
[![Test](https://img.shields.io/badge/tests-529%20all%20green-4FC08D?logo=vitest&logoColor=white)](#-项目状态)
...
- **68 个测试文件 / 529 个测试全绿**，`tsc --noEmit` 通过，构建通过。
...
- 当前 beta 留点：token 真值回填、宿主漏记软提示、预算默认值校准、auto 记账方式。
