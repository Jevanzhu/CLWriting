...
[![Test](https://img.shields.io/badge/tests-1196%20all%20green-4FC08D?logo=vitest&logoColor=white)](#-项目状态)
...
| 测试 | vitest（1196 单测）+ Playwright（19 e2e） |
...
- **145 个测试文件 / 1196 单测全绿 + 19 个 e2e 全绿**，`tsc --noEmit` 通过，`build:all` 构建通过。
