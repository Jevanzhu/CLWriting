...
[![Test](https://img.shields.io/badge/tests-1287%20all%20green-4FC08D?logo=vitest&logoColor=white)](#-项目状态)
...
| 测试 | vitest（1287 单测）+ Playwright（20 e2e） |
...
- **155 个测试文件 / 1287 单测全绿 + 20 个 e2e 全绿**，`tsc --noEmit` 通过，`build:all` 构建通过。
