...
**P1/P2 全修，P3 已修 14 / 立项登记 4 / 维持既有登记 5，随批全量回归绿——仓库面收口。** P1 终局处置 = 同版本重发（作者指令 2026-09-20「直接用现在的版本号，重新打包上架发布」：版本不 bump、tag 移指修复批提交重跑发布链、release job 删旧建新并复位已发布态），执行态见总览 §三。
