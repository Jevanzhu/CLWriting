...
- 📥 **归档记（2026-09-15）**：已收口（2026-09-13 修复批 P2×2 + P3×4 六件全修，处置记 = 报告 §八），随 2026-09-15 归档批（作者指令「归档」）自 `01-评审/` 移入 `Archive/`（扁平冷库）；历史正文不改写。
...
- **规模与测试**〔评审时点 2026-09-13 基线 `2f59db89`，随修复/后续批演进不再回改——复审-0914-修复批 P3-R4-1 补标〕：src 961 文件 / 约 35.3 万行；test 1126 文件 / 7255 用例（win 口径 7176 过 + 84 跳，差值锚 79）；e2e 31 specs / 51 用例（49 过 + 2 跳）。
- **余量**〔同上评审时点口径——P2×2 / P3×4 已随 2026-09-13 修复批 d724966d 全处置，现行余量见台账 §一〕：台账在案 3 项挂账（§四.6）+ 本轮 P2×2 / P3×4 待作者处置指令。无功能性缺口；距 1.0.0 正式的剩余工作 = 登记边角处置 + 待拍板项收口。
