...
> 归档记：2026-09-11 重评修复批同日收口（作者指令「全部修复，编排下任务，并发做。」）后自 `01-评审/` 移入 `Archive/` 扁平；历史正文不改写，收口态见头部行与 §八收口记。2026-09-12 dev←win 合并批：mac 线对同批发现的 R0912 修复批收口补记并入本正本（下方〔收口补记 2026-09-12〕），两线收口记并存。
...
- 收口状态：**已收口**（双线各一批办结——win 线 2026-09-11 重评修复批同日办结〔作者指令「全部修复，编排下任务，并发做。」，收口记 §八〕；mac 线 R0912 修复批 2026-09-12 办结〔下方收口补记〕；正本随批归档 `Archive/`）。
