...
// R0916-7-P3-3：token 折算单源迁 src/shared/tokens.ts（原 process/prepare.ts，无兼容层）
import { estimateTokens, TOKEN_COEFFICIENTS, DEFAULT_TOKEN_COEFF } from '../../src/shared/tokens.js'
