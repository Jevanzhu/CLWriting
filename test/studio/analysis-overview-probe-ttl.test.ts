 ...
 * 不对称，two-tier-signature-probe 头注自认「分析侧未节流，行为不变」）。修复后照
 ...
 * 确定性不依赖墙钟 5s（先例 version-stats-probe-ttl 同款）。
 */
...
/** 建书：manifest 登记 doc_1 + score 信封（口径同 two-tier-signature-probe makeAnalysisBook）。 */
